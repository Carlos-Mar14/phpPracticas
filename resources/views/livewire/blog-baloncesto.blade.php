<div>
    ...
    <body>
        <header>
            <h1>Beneficios del Baloncesto para la Salud</h1>
        </header>
        <main>
            <section class="beneficios">
                <h2>Beneficios para la Salud Física</h2>
                <div class="beneficio">
            ...
            <script>
                Livewire.on('commentAdded', () => {
                    // Actualiza la lista de comentarios si es necesario
                    console.log('Nuevo comentario agregado');
                });

                Livewire.on('commentUpdated', () => {
                    // Actualiza el comentario editado si es necesario
